    ...
    <>
      <section className='bg-[url("/images/seo-agentur-hero-bg.png")] bg-cover bg-bottom relative pt-[188px] md:pt-[204px] xl:pt-[216px] md:pb-[134px] pb-[110px] xl:pb-36'>
        <div className="max-w-310 md:px-10 px-4 xl:px-5 mx-auto w-full">
          <div className="text-center xl:max-w-197.5 max-w-[500px] w-full mx-auto">
        ...
        <span className="text-gradient2 absolute -bottom-8 left-0 text-center w-full block font-bold 3xl:text-[155px] xl:text-[11vw] md:text-[81px] text-[41px] leading-[42px] md:leading-21 xl:leading-[104%] -tracking-[3px] md:-tracking-[6.48px] xl:tracking-[-12.4px] uppercase">
          SEO-OPTIMIERUNG
        </span>
      </section>
        ...
        <div className='lg:bg-[url("/images/case-bg.png")] lg:pb-0 sm:pb-[194px] sm:bg-[url("/images/case-bg-tab.png")] bg-[url("/images/case-bg-mobile.png")] bg-cover lg:bg-center sm:bg-bottom bg-top md:mt-16 mt-10 xl:mt-22'>
          <div className="max-w-310 md:px-10 px-4 xl:px-5 mx-auto w-full">
            ...
            <div className="flex items-center justify-center">
              <img src="/images/Chart1.svg" className="lg:block sm:hidden" alt="Chart 1" />
            </div>
          </div>
        </div>
      </section>
      ...
      <section>
        <div className='bg-[url("/images/case3-bg.png")] bg-cover bg-center'>
          <div className="max-w-310 md:px-10 px-4 xl:px-5 mx-auto w-full">
            <h3 className="xl:text-[32px] md:text-2xl md:leading-7.25 text-lg leading-5.5 md:tracking-normal -tarcking-[0.18px] text-center font-medium text-white-1100 xl:leading-[124%]">
      ...
      <section
        ref={sectionRef}
        className="relative bg-[url('/images/Call-to-Action-Banner.png')] bg-cover bg-center pt-8.75 xl:pt-10.25"
      >
        ...
        <div className="flex md:items-center md:flex-row flex-col-reverse items-center 2xl:gap-17.75 gap-10 md:gap-13.75 xl:gap-7.5">
          ...
          <div className="md:w-8/12 md:pt-0 pt-5 xl:max-w-full max-w-[500px] w-full md:px-0 px-4 md:text-left text-center">
            <div className="">
              <h3 className="text-white-1100 xl:block hidden max-w-199.75 w-full xl:text-5xl md:text-[29px] md:leading-10 text-xl leading-6 md:tracking-normal -tracking-[0.4px] xl:leading-[124%] font-semibold uppercase mb-3 xl:mb-12">
                Erhalte Antworten auf deine SEO-Fragen – wir beraten dich
                persönlich!
              </h3>
              <h3 className="text-white-1100 xl:hidden block max-w-199.75 w-full xl:text-5xl md:text-[29px] md:leading-10 text-xl leading-6 md:tracking-normal -tracking-[0.4px] xl:leading-[124%] font-semibold uppercase mb-3 xl:mb-12">
                Erhalte Antworten auf deine SEO-Fragen{" "}
                <span className="hidden xl:inline-block">–</span>
                <span className="xl:inline-block block xl:text-5xl xl:leading-[124%] md:text-xl md:leading-7 text-base leading-[19px]">
      ...
      <section className="xl:py-50 md:py-41 py-22">
        <div className="max-w-308  md:px-10 px-4 xl:px-4 mx-auto w-full">
          <div className="text-center border-b border-solid border-white-1100/40 pb-10 relative">
            ...
            <div className="text-center mt-8 xl:mt-12 inline-block sm:w-auto w-full" onClick={open5}>
              <CtaButton
                className="seo-btn"
                href=""
          ...
          <div className="md:pt-22 pt-8">
            ...
            <div className="grid xl:grid-cols-2 xl:gap-8 mt-8 md:mt-16 xl:mt-22">
              <div className="mb-4 md:mb-6 lg:mb-4">
                <div className="xl:hidden block bg-gradient rounded-2xl shadow-4xl px-4 py-6 md:px-10 md:py-8  mb-4 md:mb-6 lg:mb-8">
                ...
                <div className="bg-black-1200 rounded-2xl shadow-4xl md:px-10 px-4 py-6 md:py-8 mb-4 md:mb-6 lg:mb-8">
                  <h4 className="text-white-1100 md:text-2xl lg:font-semibold font-medium md:tracking-normal -tracking-[0.18px] text-lg leading-5.5 md:leading-[140%] mb-4">
                    <span className="text-orange-1100 block">
                ...
                <div className="bg-black-1200 rounded-2xl shadow-4xl px-4 py-6 md:px-10 md:py-8 xl:h-[calc(100%-440px)]">
                  <h4 className="text-white-1100 md:text-2xl font-semibold md:tracking-normal -tracking-[0.18px] text-lg leading-5.5 md:leading-[140%] mb-4">
              ...
              <div className="xl:block hidden mb-4 md:mb-6 lg:mb-0">
      ...
      <section className="relative bg-[url('/images/call-action-bg.webp')] bg-cover bg-center pt-10 md:pt-15.25 md:pb-24 pb-[287px] xl:py-26">
        <div className="max-w-308  md:px-10 px-4 xl:px-4 mx-auto w-full">
          <div className="">
      ...
      <section className="relative xl:py-50 md:py-41 py-22">
        <div className="max-w-308  md:px-10 px-4 xl:px-4 mx-auto w-full">
          <div className="text-center border-b border-solid border-white-1100/40 pb-10 relative">
            <h2 className="xl:text-5xl md:text-[32px] md:leading-11 text-xl leading-6 text-white-1100 font-bold xl:leading-[124%]">
              <span className="text-orange-1100 block">
          ...
          <div className="flex gap-8 xl:mt-22 md:mt-16 mt-12 xl:flex-row flex-col">
            <div className="flex-1 w-full">
              ...
              <div className='bg-black mt-8 rounded-2xl shadow-4xl bg-[url("/images/galaxy-img2.jpg")] bg-cover bg-center py-8 px-4 md:p-8'>
                <div className="md:mb-8 mb-6">
                  <h5 className="text-orange-1100 xl:font-bold font-semibold text-base leading-[140%]">
            ...
            <div className="xl:flex hidden flex-col xl:max-w-120.25 w-full">
              <img
          ...
          <div className="flex gap-8 xl:mt-22 md:mt-16 mt-12 xl:flex-row flex-col">
            ...
            <div className="xl:flex hidden flex-col xl:max-w-120.25 w-full order-2 xl:order-1">
              <img
      ...
      <section className="overflow-hidden">
        <div className="max-w-308  md:px-10 px-4 xl:px-4 mx-auto w-full">
          <div className="text-center border-b border-solid border-white-1100/40 pb-10 relative">
            <h2 className="md:text-[32px] text-xl md:tarcking-normal -tracking-[0.4px] xl:max-w-205 w-full mx-auto text-white-1100 font-medium leading-[124%]">

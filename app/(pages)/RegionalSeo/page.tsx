          ...
          <div className="text-center border-b border-solid border-white-1100/40 pb-10 relative">
            ...
            <ul className="flex md:flex-row flex-col items-center justify-center md:gap-10 gap-4 mt-10">
              ...
              <li className="md:w-auto w-full">
                <Link
                  href={"#"}
                  className="text-white-1100 font-normal sm:text-base text-sm sm:leading-[140%] leading-[124%] bg-orange-1100 rounded-sm h-11.5 px-3 md:w-auto w-full inline-flex items-center justify-center"
                >
            ...
            <div className="flex-1 w-full">
              <div className="bg-black-1200 rounded-2xl xl:p-8 lg:p-5 md:p-8 px-4 py-6">
                ...
                <div>
                  ...
                  <Link
                    href={"#"}
                    className="text-white-1100 xl:mt-6 lg:mt-4 mt-8 font-normal xl:text-base lg:text-sm md:text-base text-sm md:leading-[140%] leading-[124%] sm:w-auto w-full border border-solid border-orange-1100 hover:bg-orange-1100 rounded-sm h-11.5 px-3 inline-flex items-center justify-center"
                  >
                    Jetzt anfragen
                  </Link>
                </div>
            ...
            <div className="flex-1 w-full">
              <div className="bg-black-1200 rounded-2xl xl:p-8 lg:p-5 md:p-8 px-4 py-6">
                ...
                <div>
                  ...
                  <Link
                    href={"#"}
                    className="text-white-1100 xl:mt-6 lg:mt-4 mt-8 font-normal xl:text-base lg:text-sm  lg:text-sm md:text-base text-sm md:leading-[140%] leading-[124%] sm:w-auto w-full border border-solid border-orange-1100 hover:bg-orange-1100 rounded-sm h-11.5 px-3 inline-flex items-center justify-center"
                  >
                    Jetzt anfragen
                  </Link>
                </div>
        ...
        <div className="max-w-308  md:px-10 px-4 xl:px-4 mx-auto w-full">
          <div className="text-center border-b border-solid border-white-1100/40 pb-10 relative">
            ...
            <ul className="flex md:flex-row flex-col items-center justify-center md:gap-10 gap-4 mt-10">
              ...
              <li className="md:w-auto w-full">
                <Link
                  href={"#"}
                  className="text-white-1100 md:w-auto w-full font-normal md:text-base text-sm md:leading-[140%] leading-[124%] bg-orange-1100 rounded-sm h-11.5 px-3 inline-flex items-center justify-center"
                >
                  SEO-Analyse anfordern
                </Link>
              </li>
          ...
          <div className="grid lg:grid-cols-2 grid-cols-1 gap-8 lg:mt-22 md:mt-16 mt-12">
            <div className='shadow-4xl rounded-2xl xl:p-8 lg:p-6 md:p-8 px-4 py-6 bg-[url("/images/galaxy-img5.png")] bg-cover bg-center'>
              ...
              <Link
                href={"#"}
                className="text-white-1100 mt-8 md:w-auto w-full font-normal md:text-base text-sm md:leading-[140%] leading-[124%] border border-solid border-orange-1100 hover:bg-orange-1100 rounded-sm h-11.5 px-3 inline-flex items-center justify-center"
              >
                Jetzt anfragen
              </Link>
            </div>
          ...
          <div className="lg:pt-22 md:pt-16 pt-12 grid lg:grid-cols-2 grid-cols-1 lg:gap-8 md:gap-16 gap-12">
            ...
            <div className="">
              <div className="bg-white-1100 h-full xl:p-8 lg:p-6 md:p-8 px-6 py-8 rounded-2xl shadow-4xl">
                ...
                <Link
                  href={"#"}
                  className="text-white-1100 font-normal md:text-base text-sm md:leading-[140%] leading-[125%] bg-orange-1100 rounded-sm h-11.5 px-3 inline-flex items-center justify-center w-full"
                >

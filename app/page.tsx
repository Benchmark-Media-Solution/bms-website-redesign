...
"
        ...
        <div className="md:max-w-308 sm:max-w-[630px]  max-w-308  md:px-10 px-4 xl:px-4 mx-auto w-full relative z-1">
          <div className="text-center border-b border-solid border-white-1100/40 pb-8 relative">
            ...
            <div className="relative z-2">
              ...
              <div className="inline-block sm:w-auto w-full" onClick={open3}>
                <CtaButton
                  href="/"
      ...
      <section className="xl:pb-45 md:pb-30 pb-20 pt-87.5 -mt-[280px] md:-mt-45 xl:mt-[-180px] overflow-hidden">
        ...
        <div className="md:pt-17 pt-8 -mx-5 ">
          <div className="md:max-w-308 sm:max-w-157.5  max-w-308  md:px-10 px-4 xl:px-4 mx-auto w-full ">
            <CaseStudiesSlider />
          </div>
        </div>
      ...
      <section className="xl:overflow-hidden py-20 md:py-30 xl:pb-45">
        ...
        <div className="md:pt-22 pt-8">
          <div className="md:max-w-308 sm:max-w-[630px]  max-w-308  md:px-10 px-4 xl:px-4 mx-auto w-full ">
            <Articleslider />
            <div className="text-center pt-8" onClick={open6}>
              <CtaButton
                href="/"
      ...
      <section className="xl:pt-45 md:pt-30 pt-20 xl:bg-[url(/images/marketingbg.jpg)] bg-no-repeat bg-cover overflow-hidden agentur-sec relative">

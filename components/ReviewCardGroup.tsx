  ...
  useEffect(() => {
    ...
    const swiper = new Swiper(swiperElRef.current, {
      ...
      breakpoints: {
        ...
        743: { slidesPerView: 2, spaceBetween: 24 },
    ...
    <div className={`flex flex-col items-center w-full ${className}`}>
      ...
      <div className="flex items-center gap-8">
        {REVIEWS.map((_, i) => (
          ...
          style={{
  backgroundImage: i === activeIndex ? "linear-gradient(270deg, #89520E 0%, #EF8F19 54%, #89520E 100%)" : "none",
  backgroundColor: i === activeIndex ? "transparent" : "#DCDCDC",
}}
          />
        ))}
      </div>

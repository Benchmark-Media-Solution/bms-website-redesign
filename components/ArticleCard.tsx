...
export function ArticleCard({ article }: { article: Article }) {
  return (
    <div className="flex flex-col transition-all ease-in-out duration-500 hover:shadow-4xl group gap-4 items-start overflow-hidden  group md:pb-8 md:rounded-2xl h-full">
      <div className="h-60 overflow-hidden relative rounded-2xl shrink-0 w-full group">
        <div className="absolute inset-0 border border-white/50 transition-all ease-in-out duration-500 group-hover:border-transparent rounded-2xl z-10 pointer-events-none" />

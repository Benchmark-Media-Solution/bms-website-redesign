...
const Header = () => {
  ...
  return (
    <>
      ...
      >
        <div className="max-w-310 lg:px-5 md:px-[44px] px-4 mx-auto w-full">
          <nav>
      ...
      />
      <div
        className={` md:bg-[url(/images/header-mblbg.png)] bg-[url(/images/mobile-bg.png)] bg-no-repeat bg-cover xl:bg-none xl:bg-black-1100
    fixed right-0 z-55
    flex flex-col gap-6
